...
-output-filename ${HOME}/run/output/adaptive_v2/${PBS_JOBNAME}.${PBS_JOBID} \
...
--out_dir ${HOME}/scratch/workdir/llama/out/finetune/adaptive_v2 \
--data JSON --data.json_path ${HOME}/scratch/workdir/llama/dataset/alpaca1024 \
--config ${HOME}/scratch/workdir/llama/adaptive.yaml \
